...
class Friend(models.Model):
    author = models.ForeignKey(Custom_User, on_delete=models.CASCADE, related_name='follower')
    fd = models.ForeignKey(Custom_User, on_delete=models.CASCADE, related_name='following')
